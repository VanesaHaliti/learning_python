...
'''Step 2: Write a function that can take in a player input and assign their marker as 'X' or 'O'. Think about using while loops to continually
...
def player_input():
    ...
    while not (marker == 'X' or marker == 'O'):
        marker = input('Hey player 1, do you want to be X or O? ').upper()
